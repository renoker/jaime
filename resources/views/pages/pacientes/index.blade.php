...
@section('scripts')
    ...
    <script>
        var list = @json($list);
        console.log(list);
        var listFormat = list.map(i => [i.id, i.image, i.name, i.edad, i.acopio.name, i.id]);
                            ...
                            },
                            {
                                ...
                                render: (data) => {
                                    return `<div class="flex items-center">
                                                <button type="button" class="ltr:mr-2 rtl:ml-2" onclick="onView(${data})">
                                                    <svg width="30px" height="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><defs><style>.a{fill:none;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;}</style></defs><path class="a" d="M43.5,24a22.5049,22.5049,0,0,0-39,0"/><circle class="a" cx="24" cy="24" r="7.889"/><path class="a" d="M4.5,24a22.5049,22.5049,0,0,0,39,0"/></svg>
                                                </button>                                        
                                                <button type="button" class="ltr:mr-2 rtl:ml-2" onclick="onForm(${data})">
        ...
        function onForm(id) {
            ...
            window.location.href = "pacientes/edit/" + row.id
        }

        function onDelete(id) {
            const row = list.find(f => f.id == id)
            window.location.href = "pacientes/delete/" + row.id
        }

        function onView(id) {
            const row = list.find(f => f.id == id)
            window.location.href = "pacientes/perfil/" + row.id
        }
    </script>
@endsection
